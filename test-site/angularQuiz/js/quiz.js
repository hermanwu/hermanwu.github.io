(function(){
    ...
    app.controller('QuizController',['$scope', '$http', '$sce', function($scope,$http,$sce){
        ...
        $scope.createShareLinks = function(percentage){
            ...
            var twitterLink = '<a class="btn twitter" target="_blank" href="http://twitter.com/share?text=I scored a '+percentage+'% on this quiz about Javascript">Tweet your score</a>';
